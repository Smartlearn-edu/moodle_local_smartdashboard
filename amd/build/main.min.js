    ...
    var PaymentAnalytics = {
        ...
        renderCategoryTable: function (categories, totalRevenue, currency) {
            ...
            categories.forEach(function (c) {
                ...
                var barColor = percent > 50 ? 'success' : (percent > 20 ? 'info' : 'secondary');
                ...
                html += '<div class="progress-bar bg-' + barColor + '" role="progressbar" style="width: ' + percent + '%" aria-valuenow="' + percent + '" aria-valuemin="0" aria-valuemax="100"></div>';
                html += '</div>';
                html += '</div>';
                html += '</td>';
